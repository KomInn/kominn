...
import styles from './Sok.module.scss';
...
export default class Sok extends React.Component<ISokProps> {
  public render(): React.ReactElement<ISokProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
