...
import { INyttForslagProps } from './components/INyttForslagProps';

export interface INyttForslagWebPartProps {
  description: string;
}
...
export default class NyttForslagWebPart extends BaseClientSideWebPart<INyttForslagWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<INyttForslagProps> = React.createElement(
      NyttForslag,
      {
