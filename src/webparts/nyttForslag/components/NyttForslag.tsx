...
import styles from './NyttForslag.module.scss';
...
export default class NyttForslag extends React.Component<INyttForslagProps> {
  public render(): React.ReactElement<INyttForslagProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section className={`${styles.nyttForslag}`}>
