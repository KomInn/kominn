...
export default class Forslagsliste extends React.Component<IForslagslisteProps> {
  public render(): React.ReactElement<IForslagslisteProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section className={`${styles.forslagsliste}`}>
